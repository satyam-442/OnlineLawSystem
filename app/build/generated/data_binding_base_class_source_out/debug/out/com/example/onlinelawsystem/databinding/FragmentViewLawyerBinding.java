...
public final class FragmentViewLawyerBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentViewLawyerBinding(@NonNull FrameLayout rootView,
      @NonNull LinearLayout emptyLawyerLayout, @NonNull LinearLayout lawyerAvailableLayout,
      @NonNull RecyclerView lawyerRecyclerView) {
  ...
  @NonNull
  public static FragmentViewLawyerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentViewLawyerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_view_lawyer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentViewLawyerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentViewLawyerBinding((FrameLayout) rootView, emptyLawyerLayout,
          lawyerAvailableLayout, lawyerRecyclerView);
    }
